...
parser.add_argument('--net_name', type=str, default='CT-fan-MACU-ds64', help='name of net')
parser.add_argument('--model_dir', type=str, default='model and result', help='model_MRI,model_CT,trained or pre-trained model directory')
...
parser.add_argument('--layer_num', type=int, default=8, help='D,11')
parser.add_argument('--num_features', type=int, default=32, help='G,32')
parser.add_argument('--learning_rate', type=float, default=1e-4, help='learning rate')
parser.add_argument('--ds_factor', type=int, default=64, help='{64,32,16, 8, 4} for fan-beam')
...
parser.add_argument('--loss_mode', type=str, default='L1-ssim', help='vggloss,midloss,L1,L2,Fista-net')
...
model = MACUNet(args.layer_num, args.num_features)
###################################################################################
# model
